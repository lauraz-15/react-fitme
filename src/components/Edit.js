...
/**
 * Edit fropdown options used for comments and images
 */
export const EditDropdown = ({ handleEdit, handleDelete }) => {
  return (
    <Dropdown>
      <Dropdown.Toggle as={Edit}>Custom toggle</Dropdown.Toggle>
...
/**
 * Edit fropdown options used for account edit menu
 */
