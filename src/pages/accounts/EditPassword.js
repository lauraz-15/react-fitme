        ...
        <Container>
          <Form onSubmit={handleSubmit}>
            <Form.Group>
              ...
              <Form.Control
                placeholder="my new password" type="password" value={updated_password1}
                onChange={handleChange} name="updated_password1"/>
            </Form.Group>
            ...
            <Form.Group>
              ...
              <Form.Control placeholder="confirm new password" type="password"
                value={updated_password2} onChange={handleChange} name="updated_password2" />
            </Form.Group>
