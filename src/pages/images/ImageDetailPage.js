...
/**
 * Display single image details on a seperate page
 * Display comments related to this image
 */
function ImageDetailPage() {
  ...
  /**
   * Get selected images data from API call
   * Get comments related to this image from API call
   */
  useEffect(() => {
